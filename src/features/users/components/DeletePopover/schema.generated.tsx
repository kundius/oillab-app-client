...
export type UsersDeletePopoverMutation = { __typename?: 'Mutation', userDelete: { __typename?: 'DefaultMutationResponse', success: boolean, error?: Types.Maybe<{ __typename?: 'AuthenticationError', message: string } | { __typename?: 'NotAllowedError', message: string } | { __typename?: 'NotFoundError', message: string } | { __typename?: 'ValidationError', message: string }> } };


export const UsersDeletePopoverDocument = gql`
    mutation UsersDeletePopover($id: Int!) {
  userDelete(id: $id) {
    success
    error {
      message
