...
export type ReportUpdatePageFragment = { __typename?: 'Report', id: string, stateNumber: string, totalMileage: string, lubricantMileage: string, samplingNodes: string, note?: Types.Maybe<string>, lubricant: string, sampledAt: any, expressLaboratoryResult?: Types.Maybe<{ __typename?: 'File', id: string, name: string, url: string }>, laboratoryResult?: Types.Maybe<{ __typename?: 'File', id: string, name: string, url: string }>, client: { __typename?: 'User', id: string, name: string }, vehicle: { __typename?: 'Vehicle', id: string, model: string } };
...
export type ReportUpdatePageQuery = { __typename?: 'Query', report?: Types.Maybe<{ __typename?: 'Report', id: string, stateNumber: string, totalMileage: string, lubricantMileage: string, samplingNodes: string, note?: Types.Maybe<string>, lubricant: string, sampledAt: any, expressLaboratoryResult?: Types.Maybe<{ __typename?: 'File', id: string, name: string, url: string }>, laboratoryResult?: Types.Maybe<{ __typename?: 'File', id: string, name: string, url: string }>, client: { __typename?: 'User', id: string, name: string }, vehicle: { __typename?: 'Vehicle', id: string, model: string } }> };
...
export type ReportUpdatePageMutation = { __typename?: 'Mutation', reportUpdate: { __typename?: 'ReportUpdateResponse', success: boolean, error?: Types.Maybe<{ __typename?: 'NotFoundError', message: string }>, record?: Types.Maybe<{ __typename?: 'Report', id: string, stateNumber: string, totalMileage: string, lubricantMileage: string, samplingNodes: string, note?: Types.Maybe<string>, lubricant: string, sampledAt: any, expressLaboratoryResult?: Types.Maybe<{ __typename?: 'File', id: string, name: string, url: string }>, laboratoryResult?: Types.Maybe<{ __typename?: 'File', id: string, name: string, url: string }>, client: { __typename?: 'User', id: string, name: string }, vehicle: { __typename?: 'Vehicle', id: string, model: string } }> } };
